...
import com.cgr.adapter.common.metadata.GeoObjectType;
...
//   * @param childrenTypes An array of GeoObjectType names of the types of children GeoObjects to fetch. If blank then return children of all types.
//   * @param hierarchyTypes An array of HierarchyType names of the types of hierarchies to the children are a member of.
...
//   * @throws
//   **/
//   public TreeNode getChildGeoObjects(String parentUid, String[] childrenTypes, String[] hierarchyTypes, Boolean recursive);
//    
//   /**
...
//   * @throws
//   **/   
//   public TreeNode getParentGeoObjects(String childUid, String[] parentTypes, String[] hierarchyTypes, Boolean recursive);
//   
//   
//   /**
